...
For default values view the [`lists.json`](lists.json) file. Standard CSS properties for modules, components and modifiers are not documented below - [read more](#TODO).
